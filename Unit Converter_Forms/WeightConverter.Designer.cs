namespace Unit_Converter_Forms
{
    partial class WeightConverter
    {
        ...
        private void InitializeComponent()
        {
            ...
            // toolStrip1
            // 
            toolStrip1.Items.AddRange(new ToolStripItem[] { TemperatureTool_btn, AreaTool_btn, VolumeTool_btn, LengthTool_btn });
            ...
            ToUnit_cmb.Items.AddRange(new object[] { "Kilogram", "Gram", "Milligram", "Metric Ton", "Long Ton", "Short Ton", "Pound", "Ounce", "Carrat", "Atomic Mass Unit" });
            ...
            FromUnit_cmb.Items.AddRange(new object[] { "Kilogram", "Gram", "Milligram", "Metric Ton", "Long Ton", "Short Ton", "Pound", "Ounce", "Carrat", "Atomic Mass Unit" });
